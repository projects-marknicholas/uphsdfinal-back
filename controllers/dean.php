...
class DeanController{
  ...
  public function insert_form_attachment() {
    ...
    if ($stmt->execute()) {
      ...
      $subject = 'Application Status Update';
      $body = "
        <h1>You have been referred</h1>
        <p>Hello $first_name $middle_name $last_name,</p>
        <p>You have been referred by a dean, this is your application id: <strong>$application_id</strong>.</p>
        <p>Thank you for your attention.</p>
      ";
  ...
  public function insert_entrance_application() {
    ...
    if ($stmt->execute()) {
      ...
      $body = "
        <h1>You have been referred</h1>
        <p>Hello $first_name $middle_name $last_name,</p>
        <p>You have been referred by a dean for the [Entrance Application] scholarship. Your application id is: <strong>$application_id</strong>.</p>
        <p>Thank you for your attention.</p>
      ";
    ...
    if ($stmt->execute()) {
      ...
      if ($stmt_app->execute()) {
        ...
        $body = "
          <h1>You have been referred</h1>
          <p>Hello $first_name $middle_name $last_name,</p>
          <p>You have been referred by a dean for the [Dean's List] scholarship. Your application id is: <strong>$application_id</strong>.</p>
          <p>Thank you for your attention.</p>
        ";
